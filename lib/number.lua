...
function Number.ceil(n)
    if type(n) == "number" then return math.ceil(n) end
...
function Number.min(a, b)
    if type(a) == "number" and type(b) == "number" then return math.min(a, b) end
...
function Number.max(a, b)
    if type(a) == "number" and type(b) == "number" then return math.max(a, b) end
