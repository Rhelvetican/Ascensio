...
SMODS.Joker({
    ...
    calculate = function(self, card, context)
        -- This was taken in part and modified from the original hunting season
        if (context.cardarea == G.play or context.cardarea == "unscored")
            ...
            and #context.full_hand > 1 and not context.blueprint and not context.retrigger_joker then
            local upgrade = false
            ...
            if upgrade then
                ...
                return { card = context.other_card, remove = not context.destroy_card.ability.eternal }
            end
        end
    end,
    asc_credits = {
